...
# Collect input data from camera!
# Filter stride = 3
# Sample size = 53
...
class ListaSet:
    def __init__(self, paramfile):
        print "Here is in ListaPrvd_cam.py"
    ...
    def get_input(self):
        ...
        while(self.cap.isOpened()):  
            ...
            if not ret: #end of video
                break
            down_frame = frame[105:105+(self.sampleStride*6+self.sampleSize+1)/2, 50:50+(self.sampleStride*8+self.sampleSize+1)/2]            
